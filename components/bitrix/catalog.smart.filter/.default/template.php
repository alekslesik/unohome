...
<style>
	...
	.bx-filter-parameters-box-container .additional-button 
	{
		margin-left: 15px;
	}
...
<div class="bx-filter <?=$templateData["TEMPLATE_CLASS"]?> <?if ($arParams["FILTER_VIEW_MODE"] == "HORIZONTAL") echo "bx-filter-horizontal"?>">
	<div class="bx-filter-section container-fluid" style="padding: 0; background: 0;">
		<!-- <div class="row">-->
		<!-- <div style="padding: 0;" class="<?if ($arParams["FILTER_VIEW_MODE"] == "HORIZONTAL"):?>col-12 col-sm-6 col-md-4<?else:?>col-lg-12<?endif?> bx-filter-title"><?echo GetMessage("CT_BCSF_FILTER_TITLE")?></div> -->
		<div style="padding: 0;" class="<?if ($arParams["FILTER_VIEW_MODE"] == "HORIZONTAL"):?>col-12<?else:?>col-12<?endif?> bx-filter-title"><?echo GetMessage("CT_BCSF_FILTER_TITLE")?></div>
		<!-- </div> -->
		<form name="<?echo $arResult["FILTER_NAME"]."_form"?>" action="<?echo $arResult["FORM_ACTION"]?>" method="get" class="smartfilter" style="margin-top: 15px;">
			...
			<div class="row">
				...
				foreach($arResult["ITEMS"] as $key=>$arItem)
				{
					...
					if (
						...
						continue;
					?>
					<div class="<?if ($arParams["FILTER_VIEW_MODE"] == "HORIZONTAL"):?>col-sm-6 col-md-6<?else:?>col-lg-12<?endif?> bx-filter-parameters-box <?if ($arItem["DISPLAY_EXPANDED"]== "Y"):?>bx-active<?endif?>">
						<span class="bx-filter-container-modef"></span>
			...
			<div class="row">
				<div class="col-xs-12 bx-filter-button-box">
					<div class="bx-filter-block">
						<div class="bx-filter-parameters-box-container" style="display: flex; margin-top: 15px;">
							<!-- btn btn-themes -->
							<input
								class="button"
								type="submit"
